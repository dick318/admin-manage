...
import { getCode, other } from '@/api/login'
...
.login-container {
  ...
  width: 100%;
  background-color: $bg;
  background:url('http://tw.szcoolfish.com/coolfish/tpl/static/img/background_kuyu.jpg') no-repeat center;
  .login-form {
    position: absolute;
    left: 50%;
